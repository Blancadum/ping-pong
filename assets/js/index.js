...
function resetBall() {
    ...
    ballSpeedX = Math.random() < 0.5 ? 2 : -2; // Alternar dirección inicial
    ballSpeedY = (Math.random() * 2 - 1) * 3; // Asignar velocidad aleatoria en Y
}
...
function showGameOver() {
    ...
    restartButton.onclick = () => {
        gameOverModal.classList.add('hidden'); // Oculta el modal
        resetGame(); // Función que reinicia el juego
        };
}
...
// Evento para iniciar el juego al hacer clic en "startButton"
